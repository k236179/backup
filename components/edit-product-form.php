...
<body>
    <div class="form">
        <form action="../api/product/update.php" method="POST">
            <!-- <div class="py-2">
                    <a class="btn btn-info text-white" href="../page/index.php?current=product">
                        回列表
                    </a>
                </div> -->
            <!-- 表單 -->
            <table class="table table-lg">
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" name="express" type="number" min="0" max="2"
                            value="<?= $row["express"] ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="col">庫存</th>
                    <td>
                        <input class="form-control" name="inventory" type="number" min="0"
                            value="<?= $row["inventory"] ?>">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input class="form-control" name="launched" type="number" min="0" max="1"
                            value="<?= $row["launched"] ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="col">軟刪除</th>
                    <td>
                        <input class="form-control" name="valid" type="number" min="0" max="1"
                            value="<?= $row["valid"] ?>">
                    </td>
                </tr>
                <tr>
